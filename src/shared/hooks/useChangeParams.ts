...
export const useChangeParams = (reducerToDispatch: ActionCreatorWithPayload<number>, queryParamName: string, selectType = SELECT_TYPE.MANY_ITEMS): UseChangeParamsFnReturnType => {
