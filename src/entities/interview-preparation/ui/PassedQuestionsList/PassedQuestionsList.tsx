...
const PassedQuestionsList = () => {
    ...
    const list: IMockQuestion[] = useSelector((state: AppStateType) => state.interviewPreparation.mockQuestionsList)
        ...
        <div className={classes.block}>
            <div className={classes.inner}>
                ...
                <div className={classes.listWrap}>
                    {list.map((item) => (
                        <PassedQuestionCard id={item.id} question={item.title} key={item.id}
